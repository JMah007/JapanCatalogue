...
class CatalogueViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _hotels = MutableLiveData<List<CatalogueItem>>(
        listOf(
            CatalogueItem("Niseko Ski Resort", "Hokkaido", "The most famous ski resort in all of Japan, known for having tons of light powder snow and is especially famous amongst Australians, who in recent decades have popularize the resort for skiing and snowboarding purposes.", "Hotel", R.drawable.niseko),
            CatalogueItem("Four Seasons Marunouchi", "Tokyo", "Located in the heart of Tokyo, this hotel provides the highest level of service and comfortability to all its customer. Experience all kinds of luxury from relaxing high tea to drinking in a classy night bar to enjoying French cuisine in a 3-michelin star restaurant.", "Hotel", R.drawable.fourseasons),
            CatalogueItem("W Osaka", "Osaka", "Nestled in the fun-filled heart of Shinsaibashi, W Osaka blends Japan’s celebrated cultural heritage with bold contemporary designs in a rarified milieu of playful chic and boundless luxury . Reboot all your social needs at the electric nightlife scenery of Dotonbori just around the corner.", "Hotel", R.drawable.w),
            CatalogueItem("Hakone Ashinoko Hanaori", "Kanagawa", "Featuring a terrace with views of Lake Ashi of Hakone, Ashinoko Hanaori offers a soothing hot spring bath and sauna. The property is situated  a 2-minute walk from Togendai Station on Hakone Ropeway.", "Hotel", R.drawable.hakone),
            CatalogueItem("Umino Ryotei Okinawa Nakamasou", "Okinawa", "This place offers family rooms with sea views, each room includes air-conditioning, a balcony, private bathroom, and modern amenities. It also allows all customers to enjoy a relaxing time in sauna, garden and the nearby beach.", "Hotel", R.drawable.umino),
            CatalogueItem("Ryokan Kanade", "Kyoto", "Conveniently located in central Kyoto, Ryokan KANADE offers a Japanese-style garden. Its rooms are complete with a private bathroom fitted with a bath and they provide the traditional Japanese bath robes, Yukata for whoever pleases to visit the private open-air bath on the rooftop.", "Hotel", R.drawable.kanade),
            CatalogueItem("Kominka Neri", "Fukuoka", "This hotel offers traditional Japanese tatami rooms to allow customers to fully experience the Japanese culture in their accomodation. Around the property has several tourist spots such as museum, park and a shrine.", "Hotel", R.drawable.kominka),
            CatalogueItem("Arima Grand Hotel", "Kobe", "Boasting an open-air hot springs bath and spacious garden, Arima Grand Hotel is located a 10-minute walk away from Arima Onsen Station. This hotel is also equipped with a seasonal outdoor pool, various spa and wellness facilities and also private use hot spring bath.", "Hotel", R.drawable.arima),
            CatalogueItem("Yuyaruru Saisai", "Kanazawa", "Offering views of the Sai River, Yuyaruru Saisai’s spacious Japanese-style rooms offers every customers the best possible experience through every night and also a private bath for customers to experience a relaxing time of their life. Tatami floors and Japanese futon bedding are included in all rooms.", "Hotel", R.drawable.saisai),
