...
class CatalogueViewModel : ViewModel() {
    ...
    private val _attractions = MutableLiveData<List<CatalogueItem>>(
        listOf(
            CatalogueItem("Okinawa Churaumi Aquarium", "Okinawa", "One of the biggest aquarium in the world home to 780 species of marine lives.", "Attraction", R.drawable.aquarium, false),
            CatalogueItem("Mount Fuji", "Yamanashi/Shizuoka", "Japan's tallest mountain and has visible snow on its tip all year long which is an iconic spot for hikinh and artwork inspiration.", "Attraction", R.drawable.fuji, false),
            CatalogueItem("Fushimi Inari Shrine", "Kyoto", "A shrine located in the old capital of Japan that is iconic for its thousands of vibrant red Torii gates. Takes around 12,000 steps to reach the top.", "Attraction", R.drawable.inari, false),
            CatalogueItem("Shibuya", "Tokyo", "A major commercial center that houses one of the busiest railway station in the world and boasts a population density of 16 thousand people per square kilometer.", "Attraction", R.drawable.shibuya, false),
            CatalogueItem("DisneySea Tokyo", "Chiba", "The one and only DisneySea in the world is located right next to Tokyo. It is a place that needs no introduction and provides everyone who enters a once-in-a-lifetime magical experience that will definitely bring them back again.", "Attraction", R.drawable.disney, false),
            CatalogueItem("Universal Studio Japan", "Osaka", "Universal Studio Japan is a special place that allows customers to enjoy thrilling rides and games. It offers a wide range of seasonal themed-games based on the trendiest anime.", "Attraction", R.drawable.usj, false),
            CatalogueItem("Arashiyama Bamboo Forest", "Kyoto", "Explore one of Kyoto's most iconic sight, the Arashiyama Bamboo Forest is a must-do activity for whoever visiting Kyoto. Walking down the small alley way surrounded by bamboos gives the best experience on nature.", "Attraction", R.drawable.bamboo, false),
            CatalogueItem("Nara Deer Park", "Nara", "A historical park that is home to hundreds of semi-wild deer that you can feed and interact with. These deers roam around the park freely to allow unlimited interactions between the deer and the people. Crackers for the deer are sold at a cheap price in the nearby shops for everyone to better interact with the deers.", "Attraction", R.drawable.deer, false),
            CatalogueItem("Tokyo Skytree", "Tokyo", "Tokyo Skytree is the third tallest structure in the world, boasting a height of 634 metres tall. Although it started off as a normal broadcasting tower, it is now a very well-known observation deck for both locals and tourists alike. Once you reach the top of the building, you are able to have the best view of the whole of Tokyo at a glance.", "Attraction", R.drawable.skytree, false),
            CatalogueItem("Sapporo Snow Festival", "Hokkaido", "The Sapporo Snow Festival is an event that is held every February in Hokkaido's capital city, Sapporo for only a week and it is the most famous winter activity in Japan. The festival features the country's best ice and snow sculptures that is sure to capture the hearts of every person. Truly an event that you cannot miss.", "Attraction", R.drawable.snow, false)
        )
    )
